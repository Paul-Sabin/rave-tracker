# Requirements Archive: v3.3 Settings Split
...
- [x] **SETT-15**: POST `/settings/save` rejects non-admin requests for system config fields with 403
- [x] **SETT-16**: POST `/settings/test-telegram` rejects non-admin requests with 403
...
| SETT-15 | Phase 18 | Complete |
| SETT-16 | Phase 18 | Complete |
